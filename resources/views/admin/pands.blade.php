                ...
                <div class="row">
                    <h3 class="text-dark mb-4">Products</h3>
                        <div class="col-md-6 text-nowrap">
                            <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable"><label class="form-label">Supplier&nbsp;<select class="d-inline-block form-select form-select-sm">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="get" action="/updateqty/{{ $product->id }}">
                                                <label class="form-label">Quantity</label><input class="form-control" type="text" name="quantity"value="{{ $product->quantity }}">
                                                    @error('quantity')
